...
// CHTwitterCover
#define COCOAPODS_POD_AVAILABLE_CHTwitterCover
#define COCOAPODS_VERSION_MAJOR_CHTwitterCover 0
#define COCOAPODS_VERSION_MINOR_CHTwitterCover 1
#define COCOAPODS_VERSION_PATCH_CHTwitterCover 0
